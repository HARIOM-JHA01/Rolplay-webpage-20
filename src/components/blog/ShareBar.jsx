...
export default function ShareBar({ title, slug }) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap" data-testid="share-bar">
      <span className="font-mono text-[10px] tracking-[0.2em] text-[#52525B] uppercase mr-1">
        {t("blog.share")}
      </span>
      ...
      {shareLinks.map(({ key, label, icon, href }) => (
        <a
          ...
          aria-label={label}
          className="w-8 h-8 rounded-full flex items-center justify-center border border-white/[0.08] text-[#71717A] hover:border-[#C0392B]/40 hover:text-white hover:bg-[#C0392B]/10 transition-all duration-200"
